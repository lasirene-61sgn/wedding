...
<body class="bg-gray-50 text-gray-800 antialiased overflow-x-hidden min-h-screen flex">
    ...
    <!-- Sidebar Navigation -->
    <aside id="sidebar" class="fixed top-0 bottom-0 left-0 z-50 w-64 bg-white border-r border-gray-200 p-6 flex flex-col justify-between transition-transform duration-300 ease-in-out -translate-x-full lg:translate-x-0 overflow-y-auto h-screen">
        <div>
            <!-- Brand -->
    ...
    <!-- Main Content Container (Stretches Full Width) -->
    <div class="lg:pl-64 min-h-screen flex-1 flex flex-col w-full transition-all duration-300">

        <!-- Top Navbar -->
        <header class="bg-white border-b border-gray-200 px-6 py-4 sticky top-0 z-30 flex items-center justify-between w-full">
        ...
        <!-- Dynamic Page Content (FULL WIDTH, No Max-Width restrictions) -->
