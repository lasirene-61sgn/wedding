...
<body>
    ...
    <nav id="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.host.index') }}" class="nav-link">
                    <i class="bi bi-people-fill me-3"></i> Host
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.categoryvenue.index') }}" class="nav-link">
                    <i class="bi bi-people-fill me-3"></i> Caetgory Venue
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.ceramony.index') }}" class="nav-link">
                    <i class="bi bi-people-fill me-3"></i> Ceramony
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.invitation.index') }}" class="nav-link">
                    <i class="bi bi-people-fill me-3"></i> Invitation
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.package.index') }}" class="nav-link">
                    <i class="bi bi-people-fill me-3"></i> Package
                </a>
            </li>
            <li class="nav-item">
    ...
    <div id="main-content">
        <nav class="navbar navbar-expand-lg bg-white border-bottom px-4 py-3 sticky-top">
            ...
            <div class="ms-auto">
                <span class="fw-semibold">Hello, Admin</span>
            </div>
        </nav>
